...
map_to_benchmark()
{
        ...
        case $_DISTRO in
                OSX)
                        ...
                        then
                                BENCHMARK="CIS_Apple_macOS_11.0_Big_Sur_Benchmark_v3.0.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Apple_macOS_12.0_Monterey_Benchmark_v2.0.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
                        ...
                        then
                                BENCHMARK="CIS_Apple_macOS_13.0_Ventura_Benchmark_v1.0.0-xccdf.xml"
                                PROFILE1="Level 1"
                                PROFILE2="Level 2"
                                ARFORXML="-x"
                        fi
